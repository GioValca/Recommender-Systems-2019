...
def run_KNNRecommender_on_similarity_type(similarity_type, parameterSearch,
    ...
    hyperparameters_range_dictionary["topK"] = Integer(5, 10)
    hyperparameters_range_dictionary["shrink"] = Integer(15, 40)
...
def runParameterSearch_Collaborative(recommender_class, URM_train, URM_train_last_test=None,
    ...
    try:
        ...
        if recommender_class is SLIM_BPR_Cython:
            hyperparameters_range_dictionary = {}
            hyperparameters_range_dictionary["topK"] = Integer(5, 10)
            hyperparameters_range_dictionary["epochs"] = Categorical([1500, 3000])
        ...
        if recommender_class is SLIMElasticNetRecommender:
            ...
            hyperparameters_range_dictionary["alpha"] = Real(low=1e-4, high=1e-2, prior='uniform')
